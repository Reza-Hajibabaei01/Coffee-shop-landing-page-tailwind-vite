...
import Logo from "../../assets/website/coffee_logo-LVukLjVz.png";
      ...
      <div className="container py-2">
        <div className="flex justify-between items-center gap-4">
          ...
          <div data-aos="fade-down" data-aos-once="true">
            <a
              href="#"
              className="font-bold text-2xl sm:text-3xl flex justify-center items-center gap-2 tracking-wider font-Playwrite-cz"
            >
